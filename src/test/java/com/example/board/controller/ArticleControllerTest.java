...
class ArticleControllerTest {
    ...
    public void givenSearchingKeyword_whenSearchingArticlesView_thenReturnArticlesView() throws Exception {
        //given
    ...
    public void givenNothing_whenRequestingSearchHashtag_thenReturnArticleSearchHashtagView() throws Exception {
        //given
    ...
    public void givenHashtag_whenRequestingSearchHashtag_thenReturnArticleSearchHashtagView() throws Exception {
        //given
        String hashtag = "#java";
        List<String> hashtags = List.of("#java", "#spring", "boot");
    ...
    @WithUserDetails(value = "sbTest", setupBefore = TestExecutionEvent.TEST_EXECUTION)
